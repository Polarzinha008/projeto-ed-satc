...
A ingestão e o processamento de cada etapa são orquestrados por DAGs no Airflow. As cargas de dados são feitas de forma incremental (usando conceitos de SCD Tipo 2 e UPSERT do Delta Lake) da Landing até a camada Gold.
